...
type (
	...
	FilterFunction func(in *pongo2.Value, param *pongo2.Value) (out *pongo2.Value, err *pongo2.Error)
	...
	TagParser func(doc *pongo2.Parser, start *pongo2.Token, arguments *pongo2.Parser) (pongo2.INodeTag, *pongo2.Error)
)

type tPongo2AssetLoader struct {
	baseDir  string
...
func (dal *tPongo2AssetLoader) Abs(base, name string) string {
...
func (dal *tPongo2AssetLoader) Get(path string) (io.Reader, error) {
...
// Pongo2Engine contains the django view engine structure.
...
var _ view.Engine = &Pongo2Engine{}

// Django creates and returns a new amber view engine.
func Pongo2(directory, extension string) *Pongo2Engine {
	s := &Pongo2Engine{
		directory:     directory,
		extension:     extension,
...
func (s *Pongo2Engine) Ext() string {
	return s.extension
}
...
func (s *Pongo2Engine) Binary(assetFn func(name string) ([]byte, error), namesFn func() []string) *Pongo2Engine {
...
func (s *Pongo2Engine) Reload(developmentMode bool) *Pongo2Engine {
...
func (s *Pongo2Engine) AddFunc(funcName string, funcBody interface{}) {
	s.rmu.Lock()
...
func (s *Pongo2Engine) AddFilter(filterName string, filterBody FilterFunction) *Pongo2Engine {
...
func (s *Pongo2Engine) RegisterFilter(filterName string, filterBody FilterFunction) *Pongo2Engine {
	return s.registerFilter(filterName, filterBody)
}

func (s *Pongo2Engine) registerFilter(filterName string, filterBody FilterFunction) *Pongo2Engine {
	fn := pongo2.FilterFunction(func(in *pongo2.Value, param *pongo2.Value) (*pongo2.Value, *pongo2.Error) {
		theOut, theErr := filterBody((*pongo2.Value)(in), (*pongo2.Value)(param))
...
// See http://www.florian-schlachter.de/post/pongo2/ for more about
// writing filters and tags.
func (s *Pongo2Engine) RegisterTag(tagName string, parserFn TagParser) error {
	fn := func(doc *pongo2.Parser, start *pongo2.Token, arguments *pongo2.Parser) (pongo2.INodeTag, *pongo2.Error) {
		t, err := parserFn((*pongo2.Parser)(doc), (*pongo2.Token)(start), (*pongo2.Parser)(arguments))
		return t, (*pongo2.Error)(err)
	}

	pongo2.RegisterTag(tagName, fn)
	return nil
}
...
func (s *Pongo2Engine) Load() error {
...
func (s *Pongo2Engine) loadDirectory() (templateErr error) {
...
func (s *Pongo2Engine) loadAssets() error {
	...
	set := pongo2.NewSet("", &tPongo2AssetLoader{baseDir: s.directory, assetGet: s.assetFn})
	set.Globals = getPongoContext(s.globals)
...
func (s *Pongo2Engine) fromCache(relativeName string) *pongo2.Template {
	s.mu.Lock()
...
func (s *Pongo2Engine) ExecuteWriter(w io.Writer, filename string, layout string, bindingData interface{}) error {
